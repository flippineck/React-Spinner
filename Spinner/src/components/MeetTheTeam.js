...
export function MeetTheTeam() {
  ...
  const {members} = React.useContext(TeamContext);
  ...
  return (
    <>
      <h1 className="text-center font-bold text-5xl bg-clip-text text-transparent bg-gradient-to-r from-orange-200 to-orange-700">TODO</h1>
